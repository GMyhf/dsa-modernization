...
- 最小循环节设计，使用NEXT数组来
![题目1](/Mid/DSA期中算法设计-02.png)
- 判断父子关系，注意对0的要求，采用迭代遍历
  ![题目2](/Mid/DSA算法其中算法设计-01.png)
- 树的镜面映射

![题目](/DSA期中算法设计-0.png)
![答案思路1](/DSA24期中答案算法设计-1.png)
![答案思路2](/DSA24期中答案算法设计-2.png)
![答案思路3](/DSA24期中答案算法设计-3.png)
