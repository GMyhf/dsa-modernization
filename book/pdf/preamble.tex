...
% Noto Sans Symbols 2 按 PostScript 名引用：同一款字体，Ubuntu 的 fonts-noto-core 把家族名写成
% 「Noto Sans Symbols2」，Google/Homebrew 的版本写成「Noto Sans Symbols 2」——按家族名写死哪一种，
% 另一边就「缺字体」停机（2026-09-19 两边各撞一次：d161fb5 坏 Mac、47a0107 坏 Linux）。PS 名两边一致。
\dsaRequireFont{NotoSansSymbols2-Regular}
...
\setCJKfallbackfamilyfont{\CJKrmdefault}{{Noto Sans Math},{NotoSansSymbols2-Regular}}
\setCJKfallbackfamilyfont{\CJKsfdefault}{{Noto Sans Math},{NotoSansSymbols2-Regular}}
\setCJKfallbackfamilyfont{\CJKttdefault}{{Noto Sans Math},{NotoSansSymbols2-Regular}}
