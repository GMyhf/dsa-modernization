...
\usepackage{fontspec}
\usepackage{xeCJK}
% 成品在 macOS 上编（Times/Menlo/宋体-黑体）。其他平台没有这四款字体时，
% 整本书会在 \setmainfont 处直接停机，所以逐级回退到等价的自由字体：
% 构建可复现，字形不同——发给学生的成品仍以 macOS 那一档为准。
...
\IfFontExistsTF{Heiti SC}
  ...
  {\IfFontExistsTF{Noto Sans CJK SC}
     ...
     {\setCJKsansfont{Droid Sans Fallback}%
      \setCJKmonofont{Droid Sans Fallback}[Scale=0.88]}}
