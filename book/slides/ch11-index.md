...
![图11.1 线性索引，图中的数据库记录不等长](../assets/scan/fig-11-1.png)
...
![图 11.2 二级索引文件](../assets/scan/fig-11-2.png)
...
![图 11.3 多分树](../assets/scan/fig-11-3.png)
...
![图 11.4 B 树结点的一般形式](../assets/scan/fig-11-4.png)
...
![图11.7 在3阶 B 树中插入关键码19后导致根分裂](../assets/scan/fig-11-7.png)
...
![图 11.9 3 阶 B +树](../assets/scan/fig-11-9.png)
...
![图11.15 百货销售数据库记录的位图索引示意](../assets/scan/fig-11-15.png)
...
叶子 `[10,20,30,40]` 插入 25 后分成 `[10,20]`、`[25,30,40]`；把右叶最小键 25 复制为父结点分隔键，并连接叶子链。

---

# 反例：只更新父键不接叶链

点查可能仍成功，但范围查询沿叶子链会跳过新叶，结果不完整。
